...
|-------|--------------------------------------------------------------------|---------------------------------------------|
| 01.11 | **Introduction to Data Science** Case study: Computer performance  | Exoset 1 (basics of R, vectors, ggplot2)   |
| 01.18 | **Designing Data Pipelines (I)** Case study: Computer performance  | Exoset 2 (data frames, testthat)           |
| 01.25 | **Vizualizing and Presenting Data** Case study: Airline OTP        | Exoset 3 (ggplot2)                         |
| 02.01 | **Designing Data Pipelines (II)**  Case study: Google Play         | Exoset 4 (tidyr)                           |
| 02.08 | **Relational Data**   Case study: Google Play                      | Exoset 5 (plyr, SQL)                       |
...
| 03.01 | **Modelling**      Case study: Github API                          | Exoset 8 (spark)                           |
...
| 03.29 | **Performance, profiling and Debugging**                           | Exoset 10 (rprof)                          |
