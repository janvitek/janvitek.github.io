...
| 01.18 | **Designing Data Pipelines (I)** *Case study*: Computer performance. *ToT*: ggplot, testthat, dataframes. **Read**: RfDS "Functions", RfDS "Vectors", RfDS "RMarkdown", [R3](http://janvitek.org/pubs/r3.pdf), AR "Data Structures", AR "Style Guide", AR "Subsetting"  | Exoset 1 (Simple R, performance data)           |
| 01.25 | **Vizualizing and Presenting Data** Case study: Airline OTP        | Exoset 2 (ggplot2)                          |
| 02.01 | **Designing Data Pipelines (II)**  Case study: Google Play         | Exoset 3 (tidyr)                            |
| 02.08 | **Relational Data**   Case study: Google Play                      | Exoset 4 (plyr, SQL)                        |
| 02.15 | **Programming Paradigms for Data Science**                         | Exoset 5 (substitute, objects, HO functions, environments) |
| 02.22 | **Big Data**  Case study: Github API                               | Exoset 6                                   |
| 03.01 | **Modelling**      Case study: Github API                          | Exoset 7 (spark)                            |
| 03.08 | **No Class** - Spring break                                        |                                             |
| 03.15 | **Advanced R programming**                                         | Exoset 8  (packages)                        |
| 03.22 | **Graphics and Interaction**  Markdown and Shiny                   | Exoset 9 (Python)                           |
