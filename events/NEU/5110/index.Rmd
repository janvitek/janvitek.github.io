...
| 02.08 | **Relational Data**   Case study: Google Play.  *ToT*: SQL and Databases  **Read**: RfDS "Exploratory Data Analysis", RfDS "Relational Data with dplyr" | Exoset 4 (OTP)|
| 02.15 | **Programming Paradigms for Data Science**             | Exoset 5 (Play) |
| 02.22 | **Big Data**  *Case study*: Github API. *ToT*: Spark.                             | Exoset 6 (Play)                                   |
| 03.01 | **Modelling**      *Case study*: Github API                          | Exoset 7 (Spark, OTP)  |
| 03.08 | **No Class** - Spring break                                        |                                             |
| 03.15 | **Advanced R programming**                                         | Exoset 8  (Git)                        |
