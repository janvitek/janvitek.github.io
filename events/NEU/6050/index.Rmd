...
Lectures will reviews basics of data science, reproducibility and depending on student interest and need, topics in machine learning, and programming: R, Markdown, dataframes, ggplot, tidyverse, Shiny.
 ...
 + **Lecture 2/21:**    Advanced R: Profiling and Debugging
       Papers:  _What’s in a GitHub Star?_ by Tajas Bala, 
                _Pomises and perils of mining GitHub_ by Yijia Hao, and 
               _Mining the Network of the Programmers_ by Tim Sauchuk.
 + **Lecture 2/28:** 
     Guest Lecture on _Bias in Machine Learning_ by Tina Eliassi-Rad. 
     Test-driven development for data science. 
        Papers: _What’s in a GitHub Star?_ by Qinyu.
                ...
                _A Large Scale Study of Programming Languages and Code Quality_.
...
------------------------------------    ------------------------
![](Figs/chen.jpg){height=50px}         Jiahao was one of the creators of the Julia programming language at MIT before joinging CapitalOne where he leads their data science team.
![](Figs/trsitan.jpg){height=50px}      John obtained a Phd in computer science in  programming languages theory before joining Oracle. He now leads the Machine Learning group in Boston.
------------------------------------    ---------------------------
