 ...
 **Schedule**    Thur, 6--9pm @ WVH110
    **Staff**    [Jan Vitek](http://janvitek.org) and invited lectures by Konrad Seik.
...
Lectures will reviews basics of data science, reproducibility and depending on student interest and need, topics in machine learning, and programming: R, Markdown, dataframes, ggplot, tidyverse, Shiny.
 ...
 + Lecture 0: Introduction and placement exam.
 + Lecture 1: GitHub; "Large Scale Study"; bash; exam review; [Git API notes](github_download.html)
 + Lecture 2: Data management and databases
