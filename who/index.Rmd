...
Another approach has been put forward, namely to ensure that conferences are properly index by major bibliometric databases. In the long term, this will reduce the bias against CS publication as their impact factor will be fully taken into account. Nothing prevents the community from pursuing both paths as they not mutually exclusive.
