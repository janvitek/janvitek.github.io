...
then virally through social media and personal connections. One possible explanation for
...
A number of the response indicated that the role of the ACM is unclear (`r unsure`%) or expressed frustration with the association (`r negative`%). The respondents seemed to either feel that ACM was not fulfilling its role (often this was linked with complaints about the use of DL funds), or that the many of the traditional functions of an association like the ACM could be better performed by other means.  There were also comments about the US-centric of policy efforts and the good works.

`r lobby`% of comments mentioned that lobbying governmental agencies is an important role of the association. `r policy`% mentioned working on policy matter and `r goodworks`% mentioned the "Good Works".
...
Focusing only on ACM members the proportion in favor is 
