...
`r perc(length(data$Times[acm]), total)` of respondents were members of the ACM.
...
**Observations:** _Many respondents feel strongly that authors should not be priced out of publishing.  This can be achieved by setting the price of OA to be low enough and ensuring that exemption be available for authors unable to pay._
